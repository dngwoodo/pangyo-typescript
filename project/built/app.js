...
var confirmedTotal = $('.confirmed-total'); // 그래서 type assertion을 이용하여 타입을 정해줌.
var deathsTotal = $('.deaths'); // 그래서 type assertion을 이용하여 타입을 정해줌.
var recoveredTotal = $('.recovered'); // 그래서 type assertion을 이용하여 타입을 정해줌.
var lastUpdatedTime = $('.last-updated-time'); // 그래서 type assertion을 이용하여 타입을 정해줌.
